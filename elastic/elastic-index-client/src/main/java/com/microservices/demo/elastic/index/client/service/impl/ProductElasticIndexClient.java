...
public class ProductElasticIndexClient implements ElasticIndexClient<ProductIndexModel> {

    private static final Logger LOG = LoggerFactory.getLogger(ProductElasticIndexClient.class);

    private final ElasticConfigData elasticConfigData;

    private final ElasticsearchOperations elasticsearchOperations;

    private final ElasticIndexUtil<ProductIndexModel> elasticIndexUtil;

    public ProductElasticIndexClient(ElasticConfigData configData,
                                     ElasticsearchOperations elasticOperations,
                                     ElasticIndexUtil<ProductIndexModel> indexUtil) {
    ...
    public List<String> save(List<ProductIndexModel> documents) {
        ...
        LOG.info("Documents indexed successfully with type: {} and ids: {}", ProductIndexModel.class.getName(),
                documentIds);
        return documentIds;
    }
}
